...
namespace MLModel_WebApi2
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\kseni\OneDrive\Документы\diploma\user_interactions.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"ProductId",inputColumnName:@"ProductId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"InteractionValue",MatrixColumnIndexColumnName=@"UserId",MatrixRowIndexColumnName=@"ProductId",ApproximationRank=108,LearningRate=0.00368230412214512,NumberOfIterations=784,Quiet=true}))      
